...
@section('content')
    <a href="{{route('leader.create')}}" class="btn btn-lg btn-success  btn-lg">Добавить</a>
    @if(isset($leader))
                                ...
                                @foreach($leader as $item)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; text-align: center;">
                                            <a href="{{route('leader.edit',$item->id)}}" class="btn btn-warning btn-sm">Редактировать</a>
