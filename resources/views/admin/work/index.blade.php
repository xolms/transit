...
@section('content')
    <a href="{{route('work.create')}}" class="btn btn-lg btn-success  btn-lg">Добавить</a>
    @if(isset($work))
                                ...
                                @foreach($work as $item)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; text-align: center;">
                                            <a href="{{route('work.edit',$item->id)}}" class="btn btn-warning btn-sm">Редактировать</a>
                                            <form action="{{route('work.destroy', $item->id)}}" method="post" style="display: inline-block;">
