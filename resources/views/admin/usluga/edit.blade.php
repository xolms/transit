...
@section('content')
    <div class="box box-primary">
        ...
        <div class="form-group">
            ...
            {{Form::text('alias', $usluga->alias , array('placeholder' => 'Alias', 'id' => 'alias', 'class' => 'form-control', 'maxlength' => '60', 'minlength' => '2'))}}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{Form::textarea('text_index', $usluga->text_index , array('placeholder' => 'Текст для главной', 'id' => 'text_index', 'class' => 'form-control'))}}
        </div>
        <div class="form-group">
            {{Form::label('keywords', 'Keywords')}}
            {{Form::text('keywords', $usluga->keywords , array('placeholder' => 'Keywords', 'id' => 'keywords', 'class' => 'form-control'))}}
        </div>
        <div class="form-group">
